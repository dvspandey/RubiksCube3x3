...
public class MiddleFlip {
 
	//>>>>>>>>>>>>>>>>>>>>>>>>>>> Horizontal <<<<<<<<<<<<<<<<<<<<<<<<

	public static char[][][] flipH(char cube[][][]){ 
		// Middle Flip
	...
	public static char[][][] flipCounterH(char cube[][][]){ 
		// Middle flipCounter
		char tempArr[] = new char[3];  
	...
	public static char[][][] flipV(char cube[][][]){ 
		// Middle Flip
		char tempArr[] = new char[3];  
	...
	public static char[][][] flipCounterV(char cube[][][]){ 
		// Middle flipCounter
		char tempArr[] = new char[3];  
