		...
		if((cube[5][0][1] == cube[5][1][1]) && (cube[5][1][0] == cube[5][1][1]) && (cube[5][1][2] == cube[5][1][1]) && (cube[5][2][1] == cube[5][1][1])){
			...
			main: while(true){
				...
				if(check(cube) == 4){					// add "if block" 25-dec-2020  --dvspandey
					System.out.println("\nSteps for White Cross at button..");
					break main;
				}
				cube = down(cube);				//down
				if(check(cube) == 4){					// add "if block" 25-dec-2020  --dvspandey
				...
				System.out.println("Main while loop Running...");
...
*/
		...
		System.out.println("Step1 Compleated...");
		return cube;
	...
	static int check(char[][][] cube)throws MyException{
		...
		if(cube[5][1][1] == cube[0][0][1]){
			...
			System.out.println("Change It -------> cube[0][0][1]: "+cube[0][0][1]);
		}

		if(cube[5][1][1] == cube[0][1][0]){
			count++;
		}else{
			System.out.println("Change It -------> cube[0][1][0]: "+cube[0][1][0]);
		}
		
		if(cube[5][1][1] == cube[0][1][2]){
			count++;
		}else{
			System.out.println("Change It -------> cube[0][1][2]: "+cube[0][1][2]);
		}

		if(cube[5][1][1] == cube[0][2][1]){
			count++;
		}else{
			System.out.println("Change It -------> cube[0][2][1]: "+cube[0][2][1]);
		}
		
		if(count == 4){
			System.out.println("Stop immidiatly sir! count become 4 daisy compleated");
			//Step 1.2  [make white cross at buttom with matching center with edges]			
			cube = up(cube);
	...
	*/
	static char[][][] sideTopLayer(char[][][] cube)throws MyException{
		...
		if(check(cube)<4){
			...
			System.out.println("sideTopLayer Return! ");
		}
	...
	*/
	static char[][][] sideButtomLayer(char[][][] cube)throws MyException{
		...
		if(check(cube)<4){
			...
			System.out.println("sideButtomLayer Return! ");
		}
	...
	static char[][][] elsePart(char[][][] cube)throws MyException{
		...
		elsePart:while(true){
			...
			if(check(cube) == 4 || check(cube) < 3){			// add "if block" 25-dec-2020 --dvspandey
				...
				System.out.println("I'm inside Else Part");
			...
			if(3 == check(cube)){
				...
				if(count==3)
					break elsePart;
				System.out.println("[elsePart] Continued...");
			}else{
