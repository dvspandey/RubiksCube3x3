...
function result(){
    ...
    if(faceFilled.Front !== true || faceFilled.Back !== true || faceFilled.Upper !== true || faceFilled.Lower !== true || faceFilled.Left !== true || faceFilled.Right !== true){
        ...
        var data = {
            cube:[],
            rotations:"Data Arrival :) | dvspandey..." //localStorage.getItem('username')

            //code Added [for send new format data to server] by dvspandey -18-Feb-2021
            /*
            {"cube":[[["Y","Y","Y"],["Y","Y","Y"],["Y","Y","Y"]],[["B","B","B"],["B","B","B"],["B","B","B"]],[["R","R","R"],["R","R","R"],["R","R","R"]],[["G","G","G"],["G","G","G"],["G","G","G"]],[["O","O","O"],["O","O","O"],["O","O","O"]],[["W","W","W"],["W","W","W"],["W","W","W"]]],"rotations":"Default data dvspandey..","obj":{"name":"Akshay Pandey","date":"19-JAN-2021","timeStamp":"7:53","pcName":"AkshayPC","ipAddress":"172.1.1.1"}}
             */
            ,obj:{
                name: localStorage.getItem('username'),//"Devesh Pandey", 
                date:"18-Feb-2021",
                timeStamp:"22:10",
                pcName:"dvspandeyPC",
                ipAddress:"172.1.1.1",           
        ...
        //console.log(body); //dvspandey
        // loding Screen 
        loaderscreen.style.display = 'block';
        dashboard.style.display = 'none'; 

        // Sending request to server api 
         axios.post('../../steps',body,config).then((res)=>{ //dvspandey
        //axios.post('http://localhost:3030/java-servlet-json-rubiks-cube/steps',body,config).then((res)=>{
            localStorage.setItem('data',JSON.stringify(res.data));
            location.href = 'resultDay.html';
        });
    } 
}
