...
class Step2{
	...
	/*	if(flag){
		...
		if(cube[1][0][1]==cube[1][1][1] && cube[2][0][1]==cube[2][1][1] && cube[3][0][1]==cube[3][1][1] && cube[4][0][1]==cube[4][1][1]){
			...
			System.out.println("The Cube has not white cross at top! with correct center pices of another 'sides face'.");
		}
...
*/	
	...
	static char[][][] colorFindLogicRignt(char[][][] cube, int face){
			
			if(face==4){face=1;}else{++face;}//new
			//if(cube[face][2][0] != cube[face][1][1]){//pos(7)
	...
	//*********************************************************************************
	static char[][][] colorFindLogicLeft(char[][][] cube, int face){
	...
	static char[][][] rigntAlgo(char[][][] cube,int j){
	...
	static char[][][] rightCornerPice(char[][][] cube){
	/*	
	...
	*/																																							
	...
	//***********************************************************************************
	static char[][][] leftButtomPice(char[][][] cube){
	/*	
	________________________________________________________________________________________________________________________________________________________
	|																																						|
	...
	*/
	static char[][][] possibility3(char[][][] cube){
	...
	static char[][][] centerSetting(char[][][] cube,int face){
		int j = face;
		while(true){
			// int x = (j==4) ? 1 :j+1;
...
*/				System.out.println("centerSetting Success.. ");
	...
	static char[][][] possibility3Algo(char[][][] cube,int face){
		if(face==1){
			//FD'F'D2
			cube = FrontFlip.flip(cube);
			cube = DownFlip.flipCounter(cube);
...
//****************************************************************************************************
	...
	*/
	...
	static char[][][] possibility4(char[][][] cube){
...
*/
	...
	static char[][][] randomCheckRight(char[][][] cube){
